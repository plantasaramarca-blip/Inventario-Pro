...
export const Navbar: React.FC<NavbarProps> = ({ onMenuClick, role, userEmail }) => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // No recargamos aquí, dejamos que el listener en App.tsx reaccione
      // Si por alguna razón no reacciona en 1s, forzamos reload
      setTimeout(() => {
        ...
        <div className="flex justify-between h-14 sm:h-16 items-center">
          <div className="flex items-center gap-3">
             ...
             <div className="flex items-center">
               <Package className="h-6 w-6 sm:h-7 sm:h-7 text-indigo-600" />
