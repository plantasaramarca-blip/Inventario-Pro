  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-center">
        ...
        {role === 'ADMIN' && <button onClick={() => handleOpenModal()} className="bg-indigo-600 text-white px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 shadow-xl shadow-indigo-100 hover:bg-indigo-700 active:scale-95 transition-all"><Plus className="w-4 h-4" /> Nuevo</button>}
      </div>
