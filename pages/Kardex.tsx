              ...
              <tr key={m.id} className="hover:bg-slate-50/40">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div><p className="font-black text-slate-800 text-[11px] uppercase truncate max-w-[200px]">{m.productName}</p><p className="text-[8px] text-slate-400 font-black uppercase tracking-widest">{m.destinationName || 'ALMACÉN CENTRAL'}</p></div>
                  </div>
                </td>
